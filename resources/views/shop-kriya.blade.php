		...
		<div class="container">
			<div class="txt-center p-t-160 p-b-165">
				...
				<span class="txt-m-201 cl0 flex-c-m flex-w">
					...
					<a href="{{ url('/shop-pangan') }}" class="txt-m-201 cl0 hov-cl10 trans-04 m-r-6">
						/ Belanja Pangan
					</a>
				</span>
			</div>
				...
				<div class="col-sm-10 col-md-4 col-lg-3 m-rl-auto p-b-50">
					<div class="leftbar p-t-15">
						...
						<div class="p-t-40">
							...
							<ul>
								<li class="p-b-5">
									<a href="{{ url('/shop-kriya') }}" class="flex-sb-m flex-w txt-s-101 cl6 hov-cl10 trans-04 p-tb-3">
										<span class="m-r-10">
											Semua
										</span>
                                        <?php
            								$count = DB::table('produk')->where('kategori','kriya')->count();
            							?> 
										<span>
											{{$count}}
										</span>
								...
								<li class="p-b-5">
									<a href="{{ url('/kriya-hasilKriya') }}" class="flex-sb-m flex-w txt-s-101 cl6 hov-cl10 trans-04 p-tb-3">
										<span class="m-r-10">
											Hasil Kriya
										</span>
                                          <?php
            								$chasil = DB::table('produk')->where('kategori_sub','hasil kriya')->count();
            							  ?> 
										<span>
											{{$chasil}}
										</span>
								...
								<li class="p-b-5">
									<a href="{{ url('/kriya-bahanOlahan') }}" class="flex-sb-m flex-w txt-s-101 cl6 hov-cl10 trans-04 p-tb-3">
										<span class="m-r-10">
											Bahan Baku
										</span>
                                          <?php
					...
					<div>
						<div class="flex-w flex-r-m p-b-45 flex-row-rev">
							...
							<span class="txt-s-101 cl9 m-r-30 size-w-53">
							 Menampilkan  {{ $produk->total() }} hasil produk
							</span>
						</div>
								...
								<div class="col-sm-6 col-lg-4 p-b-30">
									...
									<div class="block1">
										<div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
											<!--<img src="https://parianom.ae-techno.com/images/app/images_produk/{{$p->foto_produk}}" alt="PRODUCT" class="center-cropped" >-->
